...
'''
STATE_INDEX_NUM = 7
DEATH_INDEX, RECOVERED_INDEX, INFECTED_SYMPTOMATIC_INDEX, INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX, INFECTED_ASYMPTOMATIC_QUARANTINE_INDEX, NOT_INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX, NOT_INFECTED_ASYMPTOMATIC_QUARANTINE_INDEX = list(range(STATE_INDEX_NUM))
'''
Choices:
...
# INFECTED_SYMPTOMATIC_INDEX
AVERAGE_STAY_IN_HOSPITAL = 14
AVERAGE_INCUBATION_PERIOD = 5.2
MORTALITY_RATE = 0.06
TRANSITION_MATRIX_BASELINE[INFECTED_SYMPTOMATIC_INDEX, INFECTED_SYMPTOMATIC_INDEX] = 1 - 1 / AVERAGE_STAY_IN_HOSPITAL - 1 / AVERAGE_STAY_IN_HOSPITAL * MORTALITY_RATE / (1 - MORTALITY_RATE)
TRANSITION_MATRIX_BASELINE[RECOVERED_INDEX, INFECTED_SYMPTOMATIC_INDEX] = 1 / AVERAGE_STAY_IN_HOSPITAL
TRANSITION_MATRIX_BASELINE[DEATH_INDEX, INFECTED_SYMPTOMATIC_INDEX] = 1 / AVERAGE_STAY_IN_HOSPITAL * MORTALITY_RATE / (1 - MORTALITY_RATE)
# INFECTED_ASYMPTOMATIC_QUARANTINE_INDEX
TRANSITION_MATRIX_BASELINE[INFECTED_ASYMPTOMATIC_QUARANTINE_INDEX, INFECTED_ASYMPTOMATIC_QUARANTINE_INDEX] = 1 - (1 / AVERAGE_INCUBATION_PERIOD)
TRANSITION_MATRIX_BASELINE[INFECTED_SYMPTOMATIC_INDEX, INFECTED_ASYMPTOMATIC_QUARANTINE_INDEX] = 1 / AVERAGE_INCUBATION_PERIOD
# INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX
TRANSITION_MATRIX_BASELINE[INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX, INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX] = 1 - (1 / AVERAGE_INCUBATION_PERIOD)
TRANSITION_MATRIX_BASELINE[INFECTED_SYMPTOMATIC_INDEX, INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX] = 1 / AVERAGE_INCUBATION_PERIOD
...
class LowRiskCountry(object):
    INIT_STATE = (0.00002, 0.0004, 0.0002, 0.0002, 0.00001, 0.99916, 0.00001)
    ID = 1
    ...
    def setChoicesBaseline(self):
        ...
        logging.warning("COUNTRY,TIME,DEATH_INDEX,RECOVERED_INDEX,INFECTED_SYMPTOMATIC_INDEX,INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX,INFECTED_ASYMPTOMATIC_QUARANTINE_INDEX,NOT_INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX,NOT_INFECTED_ASYMPTOMATIC_QUARANTINE_INDEX")
    ...
    def getNewCases(self, time_we_want=200):
        ...
        all_cases = self._states[DEATH_INDEX, :time_we_want] + self._states[RECOVERED_INDEX, :time_we_want] + self._states[INFECTED_SYMPTOMATIC_INDEX, :time_we_want]
    ...
    def crowdOut(self, depart_state, num_traveller, t, destin_state):
        ...
        boarding_pre_crowdout[INFECTED_SYMPTOMATIC_INDEX] = 0
        ...
        people_on_plane[INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX] = max(0, min(1.149 * np.power(depart_state[INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX] / AVERAGE_INCUBATION_PERIOD, 0.5), 0.5 * depart_state[INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX]))
    ...
    def applyPolicyOnMatrix(self, current_state, lt, islocal, trace):
        ...
        real_used_transition_matrix[INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX, NOT_INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX] = min(lt * (infected_nq / nq_tot) * (healthy / nq_tot), 0.9)
        ...
        if islocal:
            ...
            num_people_infect = min(num_people_infect, AVERAGE_INCUBATION_PERIOD)
            # theoretical quarantine probability
            ianq_iaq_theory = np.power(num_people_infect / AVERAGE_INCUBATION_PERIOD, 0.5) * trace
            # theoretical hospitalization probability
            ianq_is_theory = real_used_transition_matrix[INFECTED_SYMPTOMATIC_INDEX, INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX]
        ...
        real_used_transition_matrix[INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX, INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX] = 1 - real_used_transition_matrix[INFECTED_ASYMPTOMATIC_QUARANTINE_INDEX, INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX] - real_used_transition_matrix[INFECTED_SYMPTOMATIC_INDEX, INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX]
    ...
    def peopleLeaveLowFromLowView(self, t):
        ...
        leave_low_risk[INFECTED_SYMPTOMATIC_INDEX] = 0
    ...
    def someoneWantToEnterLowWhenT(self, t, from_country, traveller_num, dayQ):
        ...
        if test_num > 0:
            ...
            people_get_off_plane[INFECTED_SYMPTOMATIC_INDEX] += people_get_off_plane[INFECTED_ASYMPTOMATIC_NOT_QUARANTINE_INDEX] - false_negative_ianq
...
class MediumRiskCountry(LowRiskCountry):
    INIT_STATE = (0.000004, 0.0002, 0.0008, 0.002, 0.00001, 0.996976, 0.00001)
    ID = 2
...
class HighRiskCountry(LowRiskCountry):
    INIT_STATE = (0.00007, 0.0001, 0.0016, 0.003, 0.001, 0.99323, 0.001)
    ID = 3
